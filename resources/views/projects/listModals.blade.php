<div class="listModals">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="modal-footer">
                                    ...
                                    {{-- button save --}}
                                    <button type="submit" class="btn btn-save waves-effect waves-light">Save Changes
                                    </button>
                                </div>
                            </div>
                        </div>
    ...
    <form action="{{ route('recordDocument.update') }}" class="parsley-examples" novalidate="" method="post"
          enctype="multipart/form-data">
        @csrf
        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3">
                                <label for="description_cost" class="form-label">Description<span
                                        class="text-danger">*</span></label>
                                <textarea type="text" name="description" parsley-trigger="change" id="description_cost"
                                          required
                            ...
                            <div class="col-6">
                                ...
                                <div class="mb-3">
                                    <label for="description_operational" class="form-label">Description<span
                                            class="text-danger">*</span></label>
                                    <textarea name="description" parsley-trigger="change" id="description_operational"
                                              required=""
