                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="embed-responsive embed-responsive-16by9">
                                <iframe class="embed-responsive-item" src="{{ asset('contoh.pdf') }}" style="width:100%; height:700px;"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <th scope="row" >
                                                ...
                                                <p class="details-text formatTanggal">00/00/00</p>
                                            </th>
                                        </tr>
                                        <tr>
                                            <th colspan="2">
                                        ...
                                        <tr>
                                            <th colspan="2" class="text-center d-flex">
                                                <button type="button" class="btn btn-success width-lg waves-effect waves-light rounded-pill">
                                                    <i class="mdi mdi-check-all"></i> Approve
                                                </button>
                                                <button type="button" class="btn btn-danger width-lg waves-effect waves-light rounded-pill">
