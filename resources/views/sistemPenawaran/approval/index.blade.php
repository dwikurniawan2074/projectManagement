                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table id="waiting-table" class="table table-striped table-hover dt-responsive nowrap">
                                    ...
                                    <tbody>
                                        @foreach ($penawaranWaiting as $key => $pnw)
                                        <tr class="text-center">
                                            <td>{{ $loop->index+1 }}</td>
                                            <td>{{ $pnw['no_msg'] }}</td>
                                            <td>{{ $pnw['attd'] }} </td>
                                            ...
                                            <td>
                                                <div class="d-flex gap-1 justify-content-center">
                                                    <a
                                                        href="{{ route('sistemPenawaran.penawaran.preview', ['id' => $pnw['id']]) }}">
                                                        <button type="button"
                                                            class="btn btn-success btn-xs waves-effect waves-light rounded-pill">Preview</button>
                                                    </a>
                                                    <a
                                                        href="{{ route('sistemPenawaran.penawaran.edit', ['id' => $pnw['id']]) }}">
                                                        <button type="button"
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table id="approved-table" class="table table-striped table-hover dt-responsive nowrap">
                                    ...
                                    <tbody>
                                        @foreach ($penawaranApproved as $key => $pnw)
                                            <tr class="text-center">
                                                <td>{{ $loop->index+1 }}</td>
                                                <td>{{ $pnw['no_msg'] }}</td>
                                                <td>{{ $pnw['attd'] }} </td>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table id="rejected-table"
                                    ...
                                    <tbody>
                                        @foreach ($penawaranRejected as $key => $pnw)
                                            <tr class="text-center">
                                                <td>{{ $loop->index+1 }}</td>
                                                <td>{{ $pnw['no_msg'] }}</td>
                                                <td>{{ $pnw['attd'] }} </td>
