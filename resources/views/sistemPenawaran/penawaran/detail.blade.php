...
@section('headerScript')
    ...
    <style>
        ...
        <link rel="stylesheet" href="https://code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css"><style>.btn-red {
            border-radius: 5px !important;
            width: 150px;
        }
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <div class="dropdown-item sub-layanan-item">Basic
                                                                    Maintenance
                                                                </div>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                ...
                                                                <div class="dropdown-item sub-layanan-item">Full
                                                                    Maintenance
                                                                </div>
                                                                <div class="dropdown-item sub-layanan-item">Additional
                                                                    Maintenance</div>
